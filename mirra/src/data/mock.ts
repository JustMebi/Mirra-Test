...
const interests = {
  tennis: {
    id: "tennis",
    image: MediaAssets.emojis.interests.tennis,
    label: "Tennis",
  },
  golf: { id: "golf", image: MediaAssets.emojis.interests.golf, label: "Golf" },
  travel: {
    id: "travel",
    image: MediaAssets.emojis.interests.travel,
    label: "Travel",
  },
  sportscar: {
    id: "sportscar",
    image: MediaAssets.emojis.interests.sportscar,
    label: "Sports Cars",
  },
  iceskating: {
    id: "iceskating",
    image: MediaAssets.emojis.interests.iceskating,
    label: "Ice Skating",
  },
};
...
const skills = {
  photography: {
    id: "photography",
    image: MediaAssets.emojis.proSkills.photography,
    label: "Photography",
  },
  videography: {
    id: "videography",
    image: MediaAssets.emojis.proSkills.videography,
    label: "Videography",
  },
  film: { id: "film", image: MediaAssets.emojis.proSkills.film, label: "Film" },
  laptop: {
    id: "laptop",
    image: MediaAssets.emojis.proSkills.laptop,
    label: "Tech",
  },
};
...
export const mockDPConversations: DPConversation[] = [
  {
    id: "dp1",
    isAnonymous: true,
    preview: "What does Ariana do for work?",
    timestamp: "2m ago",
  },
  {
    id: "dp2",
    isAnonymous: false,
    preview: "What's your training routine like?",
    timestamp: "15m ago",
  },
  {
    id: "dp3",
    isAnonymous: true,
    preview: "How did you start creating content?",
    timestamp: "1h ago",
  },
];
...
export const mockThreads: Thread[] = [
    ...
    messages: [
      {
        ...
        text: "Hey, are you still free to hit Mission Beach later?",
        time: "11:42 am",
        isOwn: false,
      },
      {
        ...
        text: "Yes, I can do after my run. Around 4?",
        time: "11:44 am",
        isOwn: true,
      },
      {
        ...
        senderName: "Evan",
        senderAvatar: evan.avatar,
        text: "Perfect. I can bring an extra paddle if you need one.",
        time: "11:45 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Please do. Mine is still in my car from yesterday.",
        time: "11:48 am",
        isOwn: true,
      },
      {
    ...
    messages: [
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "I cleaned up the deck and added the new contact screenshots.",
        time: "9:12 am",
        isOwn: true,
      },
      {
        ...
        senderId: "u5",
        senderName: "Emmitt",
        senderAvatar: emmitt.avatar,
        text: "Nice. Did you include the intro slide too?",
        time: "9:20 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Not yet. I wanted your eyes on the flow first.",
        time: "9:23 am",
        isOwn: true,
      },
      {
        ...
        senderName: "Emmitt",
        senderAvatar: emmitt.avatar,
        text: "Can you send the file over?",
        time: "1 Hour",
        isOwn: false,
      },
    ],
    ...
    messages: [
      {
        ...
        senderId: "u3",
        senderName: "Chelsea",
        senderAvatar: chelsea.avatar,
        text: "How did your long ride feel this morning?",
        time: "7:18 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Better than expected. My legs were heavy at first but opened up after 20 minutes.",
        time: "7:34 am",
        isOwn: true,
      },
      {
        ...
        senderName: "Chelsea",
        senderAvatar: chelsea.avatar,
        text: "That is a good sign. Make sure you actually eat before the swim block.",
        time: "7:39 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Deal. I am packing snacks now.",
        time: "7:43 am",
        isOwn: true,
      },
      {
        ...
        senderName: "Chelsea",
        senderAvatar: chelsea.avatar,
        text: "What would you like to ask about Chelsea?",
        time: "2 Hours",
        isOwn: false,
      },
    ],
    ...
    messages: [
      {
        ...
        senderAvatar: olivia.avatar,
        text: "We're planning a small tournament next weekend — I'll share details soon!",
        time: "9:40 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Olivia Brown",
        senderAvatar: olivia.avatar,
        text: "Yesterday's games were super fun, thanks everyone!!",
        time: "9:48 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Hey, does anyone want to play today?",
        time: "2 Minutes",
        isOwn: true,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "@Olivia Brown This is a sample message used for chat bubble layout testing and it continues to the next line naturally",
        time: "2 Minutes",
        isOwn: true,
      },
      {
        ...
        senderName: "Olivia Brown",
        senderAvatar: olivia.avatar,
        text: "@Andriy Boychuk one line message",
        time: "Now",
        isOwn: false,
      },
    ],
  },
  {
    ...
    unread: 0,
    groupAvatars: [
      MediaAssets.images.californiaExplorers,
      evan.avatar,
      chelsea.avatar,
    ],
    messages: [
      {
        id: "ca1",
        senderId: "u2",
        senderName: "Evan Nicolini",
        senderAvatar: evan.avatar,
        text: "I found a route that starts near the pier and ends close to the museum.",
        time: "10:03 am",
        isOwn: false,
      },
      {
        id: "ca2",
        senderId: "u3",
        senderName: "Chelsea Smithback",
        senderAvatar: chelsea.avatar,
        text: "That works for me. I can meet everyone at the coffee shop first.",
        time: "10:08 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Coffee first sounds perfect. I want to take a few photos before it gets crowded.",
        time: "10:12 am",
        isOwn: true,
      },
      {
        id: "ca4",
        senderId: "u7",
        senderName: "Andriy Boychuk",
        senderAvatar: andriy.avatar,
        text: "@Chelsea Smithback save me a seat if you get there early.",
        time: "10:16 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Of course. I will grab a table outside.",
        time: "10:18 am",
        isOwn: true,
      },
      {
        ...
        senderName: "Evan Nicolini",
        senderAvatar: evan.avatar,
        text: "Should we do the walk before lunch or after?",
        time: "10:25 am",
        isOwn: false,
      },
      {
        ...
        senderName: "Me",
        senderAvatar: mockCurrentUser.avatar,
        text: "Let's visit the museum first",
        time: "Sunday",
        isOwn: true,
      },
    ],
