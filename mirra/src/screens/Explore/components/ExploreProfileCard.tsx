...
export const ExploreProfileCard = React.memo(function ExploreProfileCard({
  user,
  isActive = true,
  style,
  ...
  return (
    <View style={[styles.card, style]}>
      ...
      <FrostedGlassView
        ...
        borderRadius={0}
        variant="borderless"
        fillVariant="exploreBottomGradient"
        blurVariant="blur20"
        animatedEdges={false}
      />
        ...
        >
          ...
          >
            ...
            <MetadataSection
              title="Role"
              icon="role-target"
              value={user.roleType ?? user.role}
            />
            <MetadataSection
              title="Education"
              icon="book-open"
              value={getEducationLabel(user.id)}
            />
          </ScrollView>
        </FrostedGlassView>
      </View>
    ...
    <View style={styles.emojiSection}>
      ...
      <View style={styles.crisscrossRow}>
        ...
        {extra > 0 && (
          ...
          >
            <Text
              style={[styles.extraText, { transform: [{ rotate: "14deg" }] }]}
            >
              +{extra}
            </Text>
          </FrostedGlassView>
